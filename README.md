...
No arquivo de exercícios há:
- Para **cada biblioteca**, foram postos **20 exercícios** para estimular a prática (totalizando 80)
- **Sumário** dos exercícios
- Utilização das bibliotecas: **NumPy**, **SciPy**, **Pandas** e **Matplotlib**
- **Questões** ordenadas respectivamente com as **seções das bibliotecas** utilizadas
- **Respostas** de acordo com as questões
- **Justificativas** (tanto comentadas quanto em blocos de texto)
---
...
No notebook há:
- **Avaliação de desempenho**, usando métricas clássicas
- **Apresentação** da *Análise Exploratória de Dados (AED)*
- **Desenvolvimento** do modelo de classificação com *Support Vector Machine* (**SVM**)
- **Documentação** de todo o *workflow* de *Machine Learning*
- **Representação gráfica** e **explicação metódica** de conceitos de *Machine Learning*
